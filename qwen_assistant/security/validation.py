            ...
            if isinstance(value, str):
                for pattern in self.MALICIOUS_PATTERNS:
                    if re.search(pattern, value, re.IGNORECASE):
                        return False, f"Parameter '{key}' contains potentially harmful content"
...
class ResponseValidator:
    ...
    def validate_agent_response(self, response: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
        """
    ...
    def prepare_safe_response(self, 
                              success: bool, 
